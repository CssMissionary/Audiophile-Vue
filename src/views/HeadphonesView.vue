<template>
  <div class="headphones-page">
    <PagetitleComponent title="Headphones"/>
    <ProductlineComponent line="headphones"/>
...
import PagetitleComponent from '@/components/desktop/PagetitleComponent.vue';
